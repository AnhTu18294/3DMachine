...
{
    class DetectorCalibBright : BaseMessage
    {
        private static readonly NLog.Logger Logger = LogManager.GetCurrentClassLogger();

        private byte mData;

        public DetectorCalibBright(MessageType messageType = MessageType.DETECTOR_CALIB_BRIGHT_MESSAGE) : base(MessageType.DETECTOR_CALIB_BRIGHT_MESSAGE)
        {
            mData = 0x00;
        }
